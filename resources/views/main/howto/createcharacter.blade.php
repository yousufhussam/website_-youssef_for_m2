<div id="tutorialScoller">
    <div class="scrollable">
        <div class="items">
            <!-- 1-5 -->
            <div>
                <img src="{{ asset('assets/main/img/tutorial/1_1.jpg') }}" width="480" height="360" alt="" />
                <p class="pager">1 / 4</p>
            ...
            <div>
                <img src="{{ asset('assets/main/img/tutorial/1_2.jpg') }}" width="480" height="360" alt="" />
                <p class="pager">2 / 4</p>
            ...
            <div>
                <img src="{{ asset('assets/main/img/tutorial/1_3.jpg') }}" width="480" height="360" alt="" />
                <p class="pager">3 / 4</p>
                <p class="txt">Alege un Imperiu si apasa butonul "Alege" apoi vei putea selecta si tipul caracterului tau.</p>
            </div>
            <div>
                <img src="{{ asset('assets/main/img/tutorial/1_4.jpg') }}" width="480" height="360" alt="" />
                <p class="pager">4/ 4</p>
